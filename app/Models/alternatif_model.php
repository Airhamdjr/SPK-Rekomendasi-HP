...
class alternatif_model extends Model
{
    ...
    {
        $dataquery1=$this->db->query("select max(C1) as maxminK1, max(C2) as maxminK2, max(C3) as maxminK3,  max(C4) as maxminK4, max(C5) as maxminK5, max(C6) as maxminK6, max(C7) as maxminK7 from data_alternatif");
        ...
        return array('maxmin' => $rdataquery1, 'all' => $rdataquery2,'B1' => $rdataquery3,'B2' => $rdataquery4,'B3' => $rdataquery5,'B4' => $rdataquery6,'B5' => $rdataquery7,'B6' => $rdataquery8,'B7' => $rdataquery9) ;
    }
